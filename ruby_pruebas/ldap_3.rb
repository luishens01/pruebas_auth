...
class SinatraApp < Sinatra::Base
  ...
  post '/auth/ldap/callback' do
    erb "
    <a href='http://localhost:4567/developer'>Developers access</a><br>
    <a href='http://localhost:4567/customer'>Customers access</a><br>
    <a href='http://localhost:4567/logout'>Logout</a><br>"
  end
